...
running_csv_file_name = paste(current_data_directory,"/FiGAS_sp600_by_text.csv", sep = "")
final_csv_file_name = paste(current_data_directory, "/FiGAS_sp600_by_text_final.csv", sep = "")
